...
function loadMember(data){
	...
	if(ob.length != 0){
		for(var o in ob){
	  		$(".project-sq-avatar").append('<li><a href="javascript:;" title="'+ob[o].nickname+'" target="_blank" ><img src="//atts.w3cschool.cn/attachments/avatar2/avatar_'+ob[o].uid+'.jpg"></a></li>');
    	}
	}
}
function setPaytype(){
