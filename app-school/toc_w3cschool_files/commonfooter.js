				...
				if (isMobile() || thisUrl.indexOf("w3cschool.cn/learn") != -1) {
					...
					if (res.statusCode == "200" && typeof info.username !== "undefined") {
						...
						if(typeof _MEIQIA != 'undefined'){
							// 传递顾客信息
							_MEIQIA('metadata', {     
								name: info.nickname, // 美洽默认字段   
								address: info.city, // 美洽默认字段  
								gender: info.sex,   
								email: info.email,
								tel: info.phone,
								uid: info.uid // 自定义字段       
						...
						$(".sig-box").length > 0 && $(".sig-box").each(function () {
							sigBoxTpl = '' +
								'<div class="clearfix site-userInfo">' +
									'<a class="fl link notice" href="' + webdomain + '/my#inbox" title="我的消息">' +
										'<i class="i-icon i-icon-notice-outline"></i><span class="badge' + (info.num > 0 ? ' danger' : '') + '">' + info.num + '</span>' +
									'</a>' +
									...
									'<div class="fl user">' +
										...
										'<a class="fl link user-vip" href="' + webdomain + '/vip?fcode=headeruser">' +
											'<img src="' + vipIconSrc + '" alt="' + vipInfoTitle + '" width="20" height="18" title="' + vipInfoTitle + '">' +
										'</a>' +
										...
										'<div class="text-center dropdown">' +
											'<div class="dropdown-inner">' +
												'<ul class="dropdown-content">' +
													'<li><a class="link" href="' + webdomain + '/my"><i class="i-icon i-icon-my"></i>个人中心</a></li>' +
									...
									'<div class="widget-main" style="display: none;">' +
										'<div class="widget-box">' +
											...
											'<div class="quicklogin quick-box">' +
												...
												'<a href="javascript:;" onclick="wechatqr();" class="weixina"><i class="pop-sns icons-weixin-widget"></i>微信登录</a>' +
						...
						var vipTpl = "" +
							"<div class='vip-cell'>" +
								...
								"<ul class='vip-cell-right'>" +
									"<li class='clearfix'>" +
										"<a href='/vip?fcode=indexquick_minic' class='fl link' target='_blank'><i class='priv-icon2 priv-icon2-minic'></i>会员好课</a>" +
										"<a href='/vip?fcode=indexquick_exam' class='fr link' target='_blank'><i class='priv-icon2 priv-icon2-exam'></i>专享题库</a>" +
									"</li>" +
									"<li class='clearfix'>" +
										"<a href='/vip?fcode=indexquick_cert' class='fl link' target='_blank'><i class='priv-icon2 priv-icon2-cert'></i>学习证书</a>" +
										"<a href='/vip?fcode=indexquick_vouth' class='fr link' target='_blank'><i class='priv-icon2 priv-icon2-vouth'></i>代金礼券</a>" +
									"</li>" +
									"<li class='clearfix'>" +
										"<a href='/vip?fcode=indexquick_download' class='fl link' target='_blank'><i class='priv-icon2 priv-icon2-download'></i>教程下载</a>" +
										"<a href='/vip?fcode=indexquick_viptag' class='fr link' target='_blank'><i class='priv-icon2 priv-icon2-viptag'></i>会员标识</a>" +
									"</li>" +
									"<li class='clearfix'>" +
										"<a href='/vip?fcode=indexquick_integral' class='fl link' target='_blank'><i class='priv-icon2 priv-icon2-integral'></i>经验翻倍</a>" +
										"<a href='/vip?fcode=indexquick_noad' class='fr link' target='_blank'><i class='priv-icon2 priv-icon2-noad'></i>免广告</a>" +
									"</li>" +
								"</ul>" +
...
$(function () {
	...
	if (typeof _MEIQIA === "undefined") $toolBar.find(".service").hide();
	if (!isMobile()) $toolBar.show();
	...
	// 在线笔记
	$toolBar.find(".onlinenote").on('click',function(e){
		if(logintype){
			showNoteDialog();
		}else{
			toastr.warning("请先登录!");
		...
		'<div id="wxlogin">' +
			...
			'<div class="modal-wrap">' +
				'<div class="modal">' +
					...
					'<div class="modal-header">微信登录</div>' +
		...
		success:function(msg){
		 ...
		 if(ob.length>0){
		      ...
		      $('.notelist-box').show();
		 	  ...
		 	  var kmids='0';
              for(var o in ob){  
                str+='<li class="notelist-item"><div class="notelist-author"><a ><img src="/attachments/avatar2/avatar_'+ob[o].uid+'.jpg" class="avatar"><span class="name">'+ob[o].creator+'</span></a>';
